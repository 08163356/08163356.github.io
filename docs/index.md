...
heroText: aXing's blog
tagline: 阿兴的技术博客
# actionText: 立刻进入 →
# actionLink: /web/
# bannerBg: auto # auto => 网格纹背景(有bodyBgImg时无背景)，默认 | none => 无 | '大图地址' | background: 自定义背景样式       提示：如发现文本颜色不适应你的背景时可以到palette.styl修改$bannerTextColor变量
bannerBg: /img/axingBG.png
features: # 可选的
  - title: 技术
    details: 记录个人关于计算机系统、前端、后端、计算机网络等方向的学习、感悟
    link: /web/ # 可选
    imgUrl: /img/tech.png # 可选
  - title: 书籍
    details: 记录个人阅读过的诸如《终身学习》、《mysql》等数十本书籍的xmind、感想等
    link: /ui/
    imgUrl: /img/readbook.png
  - title: 生活
    details: 记录个人旅游、技能学习（架子鼓、游泳etc.）、日常感想等思维导图、md文档、pic内容
    link: /technology/
...
<script>
  ...
  box.innerHTML = 'Hello World! Welcome to aXing'
</script>
<style>
#vanilla-box {
  color: #11a8cd;
...
- **WeChat or QQ**: <a href="tencent://message/?uin=894072666&Site=&Menu=yesUrl" class='qq'>zkf91888</a>
- **Email**: <a href="mailto:2537334510@qq.com">2537334510@qq.com</a>
